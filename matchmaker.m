...
for i = 1:N
    ...
    for j = 1:N_species(i)
        ...
        text(secondary_button_column_xpos+small_button_L, species_yax_ypos+(N_secondary_buttons-1)*button_H,'m', 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'Fontsize', font1, 'fontweight', 'normal', 'parent', dummyax);
