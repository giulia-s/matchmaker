...
%vertical dimensions
bottom_spacing = 0.001;
y1 = 0.02;
dy = 0.015;
yh = (1-bottom_spacing-(N+2)*dy)/N;
...
x1 = 0.08;
left_dx = 0.005;
xw = 1-left_border-2*x1-4*left_dx;
button_L = 0.072;
small_button_L=button_L/3;
button_H = 21/h_screen;
dh = 0.002*710/h_screen;
button_spacing =0.001;

dummyax = axes('position', [0 0 1 1], 'xlim', [0 1], 'ylim', [0 1], 'visible', 'off', 'nextplot', 'add');
handles.title = text(left_dx, bottom_spacing, 'MATCHMAKER', 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'Fontsize', font2, 'fontweight', 'bold', 'parent', dummyax);
p_neighbour=get(handles.title,'position');
handles.save = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+ 1.3*button_L+button_spacing bottom_spacing button_L button_H], 'string', 'Save', 'style', 'pushbutton', ...
...
handles.save_fig = uicontrol('units', 'normalized',...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H],...
...
handles.accordianize = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Accordianize', 'style', 'pushbutton', ...
...
handles.masterno = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing small_button_L button_H], 'string', '1', 'style', 'edit', ...
...
handles.evaluate = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Evaluate', 'style', 'pushbutton', ...
...
handles.mark = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Mark ?', 'style', 'togglebutton', 'fontname', 'default', 'fontsize', font1, 'fontweight', 'bold', 'horizontalalignment', 'center', 'value', 0, ...
    'KeyPressFcn', 'matchmaker(''keypressed_Callback'',gcbo,[],guidata(gcbo))');
p_neighbour=get(handles.mark,'position');
handles.dummymark = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Dummies?', 'style', 'togglebutton', 'fontname', 'default', 'fontsize', font1, 'fontweight', 'bold', 'horizontalalignment', 'center', 'value', 0, ...
    'KeyPressFcn', 'matchmaker(''keypressed_Callback'',gcbo,[],guidata(gcbo))');
p_neighbour=get(handles.dummymark,'position');
handles.othermarks = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Others?', 'style', 'togglebutton', ...
...
handles.plotmp2 = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', '2nd order?', 'style', 'togglebutton', ...
...
handles.check = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Check mps', 'style', 'pushbutton', ...
...
handles.exit = uicontrol('units', 'normalized', ...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'Exit', 'style', 'pushbutton', ...
...
handles.undo = uicontrol('units', 'normalized',...
    'position', [p_neighbour(1)+p_neighbour(3) + button_spacing bottom_spacing button_L button_H], 'string', 'UNDO', 'style', 'pushbutton',...
...
for i = 1:N
    ...
    handles.bigax(i) = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy) xw yh-y1],...
        ...
        'hittest','on');
    handles.bigax2(i) = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy) xw yh-y1], 'nextplot', 'add', 'visible', 'off', 'hittest', 'off', 'clipping', 'on', 'ylim', [0 1]);
    handles.name(i) = text(left_dx+left_border/2, bottom_spacing+dy+i*(yh+dy), files.core{fileno(i)}, 'VerticalAlignment', 'top', 'HorizontalAlignment', 'center', 'Fontsize', font2, 'fontweight', 'bold', 'parent', dummyax);
    handles.minx(i) = uicontrol('units', 'normalized', ...
        'position', [left_dx bottom_spacing+dy+i*(yh+dy)-2*(button_H+dh) left_border button_H], 'string', '0', 'style', 'edit', ...
    ...
    handles.maxx(i) = uicontrol('units', 'normalized', ...
        'position', [left_dx bottom_spacing+dy+i*(yh+dy)-3*(button_H+dh) left_border button_H], 'string', '1', 'style', 'edit', ...
    ...
    handles.back(i) = uicontrol('units', 'normalized', ...
        'position', [left_dx bottom_spacing+dy+i*(yh+dy)-5*(button_H+dh) left_border button_H], 'string', '<--', 'style', 'pushbutton', ...
    ...
    handles.fwd(i) = uicontrol('units', 'normalized', ...
        'position', [left_dx bottom_spacing+dy+i*(yh+dy)-6*(button_H+dh) left_border button_H], 'string', '-->', 'style', 'pushbutton', ...
        'callback', ['matchmaker(''move_Callback'',gcbo,[],guidata(gcbo),' num2str(i) ', 1)'], 'fontname', 'default', 'fontsize', font2, 'fontweight', 'bold', 'horizontalalignment', 'center', 'KeyPressFcn', 'matchmaker(''keypressed_Callback'',gcbo,[],guidata(gcbo))');
    handles.incx(i) = uicontrol('units', 'normalized', ...
        'position', [left_dx bottom_spacing+dy+i*(yh+dy)-7*(button_H+dh) left_border button_H], 'string', '1', 'style', 'edit', ...
...
for i = 1:N
    ...
    handles.tickax{i,1} = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy) xw yhsub(i)], 'nextplot', 'add', 'color', 'none', 'xcolor', 'k', 'ylim', [0 1], 'box', 'off', 'fontsize', font1, 'yaxislocation', 'left', 'xaxislocation', 'bottom', 'hittest', 'off', 'fontweight', 'bold');
    handles.plotax{i,1} = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy) xw yhsub(i)], 'nextplot', 'replacechildren', 'visible', 'off', 'hittest', 'off');
    for j = 1:NN(i)
        if j > 1
            handles.tickax{i,j} = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i) xw yhsub(i)], 'nextplot', 'add', 'ycolor', handles.colours{i}(handles.selectedspecs{i}(j),:), 'color', 'none', 'xcolor', 'w', 'xtick', [], 'ylim', [0 1], 'box', 'off', 'fontsize', font1, 'yaxislocation', sides{mod(j,2)+1}, 'xaxislocation', 'top', 'hittest', 'off', 'fontweight', 'bold');
            handles.plotax{i,j} = axes('position', [left_border+x1+3*left_dx bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i) xw yhsub(i)], 'nextplot', 'replacechildren', 'visible', 'off', 'hittest', 'off');
        end
        handles.spec{i,j}  = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-(button_H-2*dh) left_border button_H], 'string', handles.species{i}, 'value', handles.selectedspecs{i}(j), 'style', 'popupmenu', 'callback', ['matchmaker(''spec_Callback'',gcbo,[],guidata(gcbo),' num2str(i) ',' num2str(j) ')'], 'fontname', 'default', 'fontsize', font1, 'fontweight', 'normal', 'horizontalalignment', 'center');
        handles.offset{i,j} = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-2*(button_H+dh) left_border button_H], 'string', 0, 'style', 'edit', ...
        ...
        handles.autoy{i,j} = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-3*(button_H+dh) (left_border-dh)/2 button_H], 'string', 'Aut', 'style', 'togglebutton', ...
        ...
        handles.logy{i,j}  = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx)+(left_border+dh)/2 bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-3*(button_H+dh) (left_border-dh)/2 button_H], 'string', 'Log', 'style', 'togglebutton', ...
        ...
        handles.miny{i,j} = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-4*(button_H+dh) left_border button_H], 'string', 0, 'style', 'edit', ...
        ...
        handles.maxy{i,j} = uicontrol('units', 'normalized', ...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-5*(button_H+dh) left_border button_H], 'string', 1, 'style', 'edit', ...
        ...
        handles.color_change{i,j} = uicontrol('units', 'normalized','Tooltip', ['Color'],...
            'position', [(mod(j,2)==1)*(left_border+3*left_dx)+(mod(j,2)==0)*(1-left_border-left_dx) bottom_spacing+2*dy+y1+(i-1)*(yh+dy)+(j-1)*(1-yoverlap)*yhsub(i)+yhsub(i)-6*(button_H+dh) left_border button_H],...
