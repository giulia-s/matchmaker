...
for j = no2
    ...
    set([ handles.color_change{no1, j} handles.offset{no1, j} handles.autoy{no1, j} handles.logy{no1, j} handles.revy{no1, j} handles.miny{no1, j} handles.maxy{no1, j}], 'Foregroundcolor', handles.colours{no1}(handles.selectedspecs{no1}(j),:));
