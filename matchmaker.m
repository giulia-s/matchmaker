...
handles.edit = uicontrol('units', 'normalized', ...
    'position', [axis_left_xpos+(Buttonnumber-1)*(button_L+button_x_spacing), y0, button_L, button_H2],...
    'string', 'Edit mps', 'style', 'togglebutton', 'fontname', 'default', 'fontsize', font1, 'fontweight', 'bold', 'horizontalalignment', 'center', 'value', 0, 'Backgroundcolor', butcol, ...
...
handles.ref_mark = uicontrol('units', 'normalized', ...
    'position', [axis_left_xpos+(Buttonnumber-1)*(button_L+button_x_spacing), y0, button_L, button_H2],...
    'string', 'Reference mps', 'style', 'radio', 'fontname', 'default', 'fontsize', font1, 'horizontalalignment', 'center', 'value', 1, 'Backgroundcolor', figcol, ...
...
for i = 1:N
    ...
    for j = 1:N_species(i)    
        ...
        handles.spec{i,j}  = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos specax_lower_ypos+ax_species_H(i)-button_H1 xspec*(2*specwidth+specspace) button_H1],...
        ...
        handles.color_change{i,j} = uicontrol('units', 'normalized','Tooltip', 'Color',...
            'position', [specbuttoncolumn_xpos+xspec*(2*specwidth+2*specspace) specax_lower_ypos+ax_species_H(i)-button_H1 xspec*specwidth button_H1],...
        ...
        handles.autoy{i,j} = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos specax_lower_ypos+ax_species_H(i)-2*button_H1-button_y_spacing xspec*specwidth button_H1],...
        ...
        handles.logy{i,j}  = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos+xspec*(specspace+specwidth) specax_lower_ypos+ax_species_H(i)-2*button_H1-button_y_spacing xspec*specwidth button_H1],...
        ...
        % Middel right: Button to introduce offset of species (use only with care!)
        handles.offset{i,j} = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos+xspec*(2*specspace+2*specwidth) specax_lower_ypos+ax_species_H(i)-2*button_H1-button_y_spacing xspec*specwidth button_H1],...
            'string', '0', 'style', 'edit', ...
        ...
        handles.miny{i,j} = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos specax_lower_ypos+ax_species_H(i)-3*button_H1-2*button_y_spacing xspec*speclimwidth button_H1],...
            'string', 0, 'style', 'edit', ...
        ...
        % Lower right: Max y field
        handles.maxy{i,j} = uicontrol('units', 'normalized', ...
            'position', [specbuttoncolumn_xpos+xspec*(speclimwidth+specspace) specax_lower_ypos+ax_species_H(i)-3*button_H1-2*button_y_spacing xspec*speclimwidth button_H1],...
            'string', 1, 'style', 'edit', ...
