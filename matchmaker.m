...
for i = 1:N
    ...
    handles.minx(i) = uicontrol('units', 'normalized', ...
        'position', [buttons_left_edge_pos, primary_button_column_ypos-2*(button_H+button_y_spacing), small_button_L, button_H], 'string', '0', 'style', 'edit', ...
    ...
    handles.maxx(i) = uicontrol('units', 'normalized', ...
        'position', [buttons_left_edge_pos, primary_button_column_ypos-3*(button_H+button_y_spacing) small_button_L, button_H], 'string', '1', 'style', 'edit', ...
    ...
    handles.back(i) = uicontrol('units', 'normalized', ...
        'position', [buttons_left_edge_pos, primary_button_column_ypos-5*(button_H+button_y_spacing) small_button_L, button_H], 'string', '<--', 'style', 'pushbutton', ...
    ...
    handles.fwd(i) = uicontrol('units', 'normalized', ...
        'position', [buttons_left_edge_pos, primary_button_column_ypos-6*(button_H+button_y_spacing) small_button_L, button_H], 'string', '-->', 'style', 'pushbutton', ...
        'callback', ['matchmaker(''move_Callback'',gcbo,[],guidata(gcbo),' num2str(i) ', 1)'], 'fontname', 'default', 'fontsize', font2, 'fontweight', 'bold', 'horizontalalignment', 'center', 'KeyPressFcn', 'matchmaker(''keypressed_Callback'',gcbo,[],guidata(gcbo))');
    handles.incx(i) = uicontrol('units', 'normalized', ...
        'position', [buttons_left_edge_pos, primary_button_column_ypos-7*(button_H+button_y_spacing) small_button_L, button_H], 'string', '1', 'style', 'edit', ...
...
for i = 1:N
    ...
    for j = 1:N_species(i)
        ...
        handles.spec{i,j}  = uicontrol('units', 'normalized', ...
            'position', [secondary_button_column_xpos  species_yax_ypos+N_secondary_buttons*button_H small_button_L, button_H],...
        ...
        handles.offset{i,j} = uicontrol('units', 'normalized', ...
            'position', [secondary_button_column_xpos species_yax_ypos+(N_secondary_buttons-1)*button_H small_button_L, button_H],...
            'string', 0, 'style', 'edit', ...
        ...
        handles.autoy{i,j} = uicontrol('units', 'normalized', ...
            'position', [secondary_button_column_xpos species_yax_ypos+(N_secondary_buttons-2)*button_H small_button_L/2, button_H],...
        ...
        handles.miny{i,j} = uicontrol('units', 'normalized', ...
            'position', [secondary_button_column_xpos species_yax_ypos+(N_secondary_buttons-3)*button_H small_button_L, button_H],...
            'string', 0, 'style', 'edit', ...
        ...
        handles.maxy{i,j} = uicontrol('units', 'normalized', ...
            'position', [secondary_button_column_xpos species_yax_ypos+(N_secondary_buttons-4)*button_H small_button_L, button_H],...
            'string', 1, 'style', 'edit', ...
        ...
        handles.color_change{i,j} = uicontrol('units', 'normalized','Tooltip', ['Color'],...
            'position', [secondary_button_column_xpos species_yax_ypos+(N_secondary_buttons-5)*button_H small_button_L, button_H],...
