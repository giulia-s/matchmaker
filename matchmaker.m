...
for i = 1:N
    ...
    for j = 1:N_species(i)    
        ...
        handles.spec{i,j}  = uicontrol('units', 'normalized', ...
            ...
            'value', handles.selectedspecs{i}(j), 'style', 'popupmenu', 'callback', ['matchmaker(''spec_Callback'',gcbo,[],guidata(gcbo),' num2str(i) ',' num2str(j) ')'], 'fontname', 'default', 'fontsize', font1, 'fontweight', 'normal', 'horizontalalignment', 'center');
